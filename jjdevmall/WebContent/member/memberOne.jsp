...
<html>
	...
	<%
			...
			try {
				...
				System.out.println(resultSetRow + " : resultSetRow memberOne.jsp");
		...
		<%
				...
				while(resultSet.next()) {
					System.out.println(count + " : count memberOne.jsp");
					address[count] = resultSet.getString("address_addr");
					System.out.println(address[count] + " : address[" + count + "] memberOne.jsp");
					count++;
